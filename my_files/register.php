...
{      
	...
	error="";    
     	if (document.newform.fname.value == "") 
		 error+="Ονομα, ";		
     	if (document.newform.lname.value == "") 
		 error+="επωνυμο, ";	
		 ...
		 error+="e-Mail, ";
		if (document.newform.job.value == "") 
		 error+="Επάγγελμα, ";
		if (document.newform.age.value == "") 
		 error+="Ηλικία, ";
	if (error!="")
	...
	<div id="ergasia_header">
        ...
        <div id="ergasia_menu" class="ddsmoothmenu">
            <ul>
          		...
          		<li><a href="register.php" class="selected">Εγγραφή</a></li>
    ...
    <div id="ergasia_main">
    	<div class="col_fw">
        	<div class="col_w660 float_l">
                ...
                <div class="cleaner h20"></div>
                <p>
		<FORM name="newform" onsubmit="return checklog();" action="signuser.php" method="post" >
							 ...
							 <TR>
                      					<TD class=bt colSpan=2>Eπώνυμο:
								</TD>
							</TR>
                    				<TR>
                      					<TD colSpan=2><INPUT id="lname" name="lname" value="" size="40">
								</TD>
							</TR>
                    				<TR>
                      					<TD class=bt colSpan=2>Ονομα:
								</TD>
							</TR>
                    				<TR>
                      					<TD colSpan=2><INPUT id="fname" name="fname" value="" size="40">
								</TD>
							</TR>
							  <TR>
                      					<TD class=bt colSpan=2>e-mail:</TD></TR>
                   				<TR>
                      					<TD colSpan=2>
  							  ...
  							  <TR>
                      					<TD class=bt colSpan=2>Επάγγελμα:</TD></TR>
                   				<TR>
                      					<TD colSpan=2>
                      					<INPUT id="job" name="job" value="" size="40">
								</TD>
							</TR> 
							 <TR>
                      					<TD class=bt colSpan=2>Ηλικία:</TD></TR>
                   				<TR>
                      					<TD colSpan=2>
                      					<INPUT id="age" name="age" value="" size="40">
								</TD>
							</TR> 
                    				<TR>
                      					<TD align="left" colSpan=2><INPUT type="submit" height=32 width=103 value="Εγγραφή">
								</TD>
							</TR>
